        ...
        (t) => {
          t.addEventListener("click", function (t) {
            ...
            Swal.fire({
              ...
              t.value
                ? Swal.fire({
                    text: "Vous avez supprimé ce employée!.",
                    icon: "success",
                    buttonsStyling: !1,
                ...
                : "cancel" === t.dismiss &&
                  Swal.fire({
                    text: customerName + " n'a pas été supprimée.",
                    icon: "error",
                    buttonsStyling: !1,
                    confirmButtonText: "Ok, compris!",
                    customClass: { confirmButton: "btn fw-bold btn-primary" },
      ...
      c.forEach((e) => {
        ...
        s.addEventListener("click", function () {
          Swal.fire({
            ...
            t.value
              ? Swal.fire({
                  text: "Vous avez supprimé all selected customers!.",
                  icon: "success",
                  buttonsStyling: !1,
                  confirmButtonText: "Ok, compris!",
                  customClass: { confirmButton: "btn fw-bold btn-primary" },
              ...
              : "cancel" === t.dismiss &&
                Swal.fire({
                  text: "Selected customers n'a pas été supprimée.",
                  icon: "error",
                  buttonsStyling: !1,
                  confirmButtonText: "Ok, compris!",
                  customClass: { confirmButton: "btn fw-bold btn-primary" },
